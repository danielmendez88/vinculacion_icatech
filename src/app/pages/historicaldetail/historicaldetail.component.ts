...
@Component({
  selector: 'app-historicaldetail',
  templateUrl: './historicaldetail.component.html',
  styleUrls: ['./historicaldetail.component.scss']
})
export class HistoricaldetailComponent implements OnInit {
  ...
  ngOnInit() {
    // set titulos
    this.Titulo.setTitle('Sivic / Lista Historicos');
    this.Agenda = this.ruta.snapshot.data.getdetallehistorico;
